...
-   Best Ball queda implementado en backend hasta la Migración 329 como
    motor separado; queda pendiente su integración UI/E2E. Shamble
    permanece como motor futuro separado.

### Best Ball

-   Integrar en frontend el motor Best Ball ya implementado en backend
    (Migraciones 315--329), reutilizando la infraestructura común donde
    corresponda y manteniendo aislada la evidencia deportiva propia.
