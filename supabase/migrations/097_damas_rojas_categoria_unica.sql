-- =========================================================
-- MIGRACIÓN 097
-- En torneos de categoría única, las damas siempre salen de
-- ROJAS — regla fija, independiente de su hándicap. No pasan
-- por las franjas de hándicap (esas son solo para caballeros).
-- =========================================================
...
comment on function resolver_categoria_y_marca is 'Asigna marca_salida_id automáticamente. En categoría única: damas siempre Rojas (regla fija); caballeros por franja de hándicap. Con varias categorías: valida/reasigna por hándicap o edad según corresponda. Con equipo, solo resuelve la marca desde la categoría heredada.';
