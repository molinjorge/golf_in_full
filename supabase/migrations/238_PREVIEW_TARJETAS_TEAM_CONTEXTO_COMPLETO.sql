...
-- Migración 238
-- Preview de tarjetas TEAM con contexto completo de torneo/ronda/campo
-- ============================================================================
-- Objetivo:
--   Enriquecer únicamente la previsualización A-Go-Go Shotgun por equipos.
--
-- Principios:
...
--   * Mantiene las claves TEAM existentes y agrega el envoltorio/aliases
--     comunes necesarios para el frontend.
-- ============================================================================
